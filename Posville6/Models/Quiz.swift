...
struct Quiz {
    ...
    static let proverbQuizzes: [Quiz] = [
        // 사자성어
        Quiz(level: .Beginning, question: "지난 날의 잘못을 고쳐 착하게 됨", options: [], rightAnswer: "개과천선"),
        Quiz(level: .Beginning, question: "죽은 뒤에도 은혜를 잊지 않고 갚음", options: [], rightAnswer: "결초보은"),
        Quiz(level: .Beginning, question: "착한 일을 권하고 악한 일을 벌함", options: [], rightAnswer: "권선징악"),
        Quiz(level: .Beginning, question: "나쁜 사람과 가까이 지내면 물들기 쉬움", options: [], rightAnswer: "근묵자흑"),
        Quiz(level: .Beginning, question: "어떤 일을 자신의 생각만으로 혼자서 처리하는 사람을 이르는 말", options: [], rightAnswer: "독불장군"),
        Quiz(level: .Beginning, question: "비슷하게 어려운 처지에 있는 사람들끼리 가엾게 여김", options: [], rightAnswer: "동병상련"),
        Quiz(level: .Beginning, question: "겉으로는 같이 행동하면서 속으로는 각기 딴 생각을 하는 것", options: [], rightAnswer: "동상이몽"),
        Quiz(level: .Beginning, question: "유명한 데에는 그 까닭이 있음", options: [], rightAnswer: "명불허전"),
        Quiz(level: .Beginning, question: "실제 상황이나 능력이 그 명성에 부합한다", options: [], rightAnswer: "명실상부"),
        Quiz(level: .Beginning, question: "많은 사람들이 모여 집 문 앞이 시장을 이루는 것 같음", options: [], rightAnswer: "문전성시"),
        Quiz(level: .Beginning, question: "손뼉을 치며 크게 웃음", options: [], rightAnswer: "박장대소"),
        Quiz(level: .Beginning, question: "다가올 일을 미리 짐작하는 밝은 지인", options: [], rightAnswer: "선견지명"),
        Quiz(level: .Beginning, question: "어려운 일이나 불행이 겹쳐서 일어남", options: [], rightAnswer: "설상가상"),
        Quiz(level: .Beginning, question: "인생의 길흉화복은 변화가 많아 예측하기 어렵다는 뜻", options: [], rightAnswer: "새옹지마"),
        Quiz(level: .Beginning, question: "둘 사이의 다툼 속에서 엉뚱한 사람이 이익을 본다는 뜻", options: [], rightAnswer: "어부지리"),
        Quiz(level: .Beginning, question: "자나깨나 잊지 못함", options: [], rightAnswer: "오매불망"),
        Quiz(level: .Beginning, question: "임시로 모여들어서 규율이 없고 무질서한 병졸 또는 군중", options: [], rightAnswer: "오합지졸"),
        Quiz(level: .Beginning, question: "선을 행하면 선의 결과가, 악을 행하면 악의 결과가 반드시 뒤따름", options: [], rightAnswer: "인과응보"),
        Quiz(level: .Beginning, question: "잘못한 사람이 도리어 아무 잘못도 없는 사람을 나무람", options: [], rightAnswer: "적반하장"),
        Quiz(level: .Beginning, question: " 나아갈 수도 후퇴할 수도 없는 곤란한 상황", options: [], rightAnswer: "진퇴양난"),
        
        Quiz(level: .Intermediate, question: "거리에 떠도는 소문", options: [], rightAnswer: "가담항설"),
        Quiz(level: .Intermediate, question: "남의 비위에 맞게 꾸민 달콤한 말과 이로운 조건으로 꾀는 말", options: [], rightAnswer: "감언이설"),
        ...
        // 속담
        Quiz(level: .Beginning, question: "가는 말이 고와야 ( )", options: [], rightAnswer: "오는 말이 곱다"),
        Quiz(level: .Beginning, question: "가는 날이 ( )", options: [], rightAnswer: "장날이다"),
        Quiz(level: .Beginning, question: "가까운 남이 ( )보다 낫다", options: [], rightAnswer: "먼 친척"),
        Quiz(level: .Beginning, question: "간에 붙었다 ( )에 붙었다 한다", options: [], rightAnswer: "쓸개"),
        Quiz(level: .Beginning, question: "남의 잔치에 ( )놓아라 ( )놓아라 한다", options: [], rightAnswer: "감, 배"),
        Quiz(level: .Beginning, question: "낫 놓고 ( )도 모른다", options: [], rightAnswer: "기역 자"),
        Quiz(level: .Beginning, question: "낮말은 새가 듣고 밤말은 ( )가 듣는다", options: [], rightAnswer: "쥐"),
        Quiz(level: .Beginning, question: "내 코가 ( )자다", options: [], rightAnswer: "석"),
        Quiz(level: .Beginning, question: "누워서 ( )", options: [], rightAnswer: "침 뱉기"),
        Quiz(level: .Beginning, question: "눈 가리고 ( )", options: [], rightAnswer: "아웅"),
